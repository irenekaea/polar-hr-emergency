...
public class MainActivity extends Activity implements OnItemSelectedListener, Observer {
    ...
    private int HEART_RATE_ALERT_VALUE = 100;
    ...
    public void receiveData() {
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                EditText heartrate = (EditText)findViewById(R.id.heartbeatalert);
                HEART_RATE_ALERT_VALUE = Integer.parseInt(heartrate.getText().toString());
                if(DataHandler.getInstance().getLastIntValue() >= HEART_RATE_ALERT_VALUE){
                    sendSMSMessage();
                }
    ...
    private void sendSMSMessage() {
        ...
        phoneNo = phoneView.getText().toString();

        TextView messageView = (TextView) findViewById(R.id.messagetosend);
